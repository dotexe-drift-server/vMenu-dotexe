...
namespace vMenuClient
{
    public class MainMenu : BaseScript
    {
        ...
        private static void PostPermissionsSetup()
        {
            ...
            PlayerSubmenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleSubmenu = new Menu(" ", "Vehicle Related Options");
            VehicleSubmenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            WorldSubmenu = new Menu(" ", "World Options");
            WorldSubmenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
