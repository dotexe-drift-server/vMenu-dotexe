...
namespace vMenuClient
{
    ...
    class FunctionsController : BaseScript
    {
        ...
        {
            if ((MainMenu.TimeOptionsMenu.freezeTimeToggle != null && MainMenu.TimeOptionsMenu.GetMenu().Visible) && IsAllowed(Permission.TOFreezeTime) && !MainMenu.PlayerTimeWeatherOptionsMenu.clientSidedEnabled.Checked)
            {
