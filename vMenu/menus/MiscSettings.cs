...
namespace vMenuClient
{
    public class MiscSettings
    {
        ...
        private void CreateMenu()
        {
            ...
            teleportOptionsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            developerToolsMenu = new Menu(" ", "Development Tools");
            developerToolsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            entitySpawnerMenu = new Menu(" ", "Entity Spawner");
            entitySpawnerMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");

            // keybind settings menu
            Menu keybindMenu = new Menu(" ", "Keybind Settings");
            keybindMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            connectionSubmenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
