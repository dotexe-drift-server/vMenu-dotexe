...
namespace vMenuClient
{
    public class WeaponLoadouts
    {
        ...
        public void CreateMenu()
        {
            ...
            SavedLoadoutsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ManageLoadoutMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
