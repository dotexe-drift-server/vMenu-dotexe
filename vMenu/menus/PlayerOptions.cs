...
namespace vMenuClient
{
    public class PlayerOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            CustomDrivingStyleMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            vehicleAutoPilot.HeaderTexture = new KeyValuePair<string, string>("header", "header");
