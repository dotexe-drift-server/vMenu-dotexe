...
namespace vMenuClient
{
    public class VehicleOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            VehicleModMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            VehicleDoorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleWindowsMenu = new Menu(" ", "Vehicle Windows Management");
            VehicleWindowsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleComponentsMenu = new Menu(" ", "Vehicle Extras/Components");
            VehicleComponentsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleLiveriesMenu = new Menu(" ", "Vehicle Liveries");
            VehicleLiveriesMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleColorsMenu = new Menu(" ", "Vehicle Colors");
            VehicleColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleRGBColorsMenu = new Menu(" ", "Vehicle RGB Colors");
            VehicleRGBColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            DeleteConfirmMenu = new Menu(" ", "Delete Vehicle, Are You Sure?");
            DeleteConfirmMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            VehicleUnderglowMenu = new Menu(" ", "Vehicle Neon Underglow Options");
            VehicleUnderglowMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            rgbPrimaryColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            rgbSecondaryColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            primaryColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            secondaryColorsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
