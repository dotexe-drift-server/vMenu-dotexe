...
namespace vMenuClient
{
    public class WeaponOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            addonWeaponsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            if (IsAllowed(Permission.WPParachute))
            {
                ...
                parachuteMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            foreach (ValidWeapon weapon in ValidWeapons.WeaponList)
            {
                ...
                if (!string.IsNullOrEmpty(weapon.Name) && IsAllowed(weapon.Perm))
                {
                    ...
                    Menu weaponMenu = new Menu(" ", weapon.Name)
                    {
                        ShowWeaponStatsPanel = true
                    };
                    weaponMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
