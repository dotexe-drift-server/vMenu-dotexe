...
namespace vMenuClient
{
    public class MpPedCustomization
    {
        ...
        private void CreateMenu()
        {
            ...
            createCharacterMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            savedCharactersMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            inheritanceMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            appearanceMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            faceShapeMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            tattoosMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            clothesMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            propsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            manageSavedCharacterMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
