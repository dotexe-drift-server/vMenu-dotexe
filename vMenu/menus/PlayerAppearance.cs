...
namespace vMenuClient
{
    public class PlayerAppearance
    {
        ...
        private void CreateMenu()
        {
            ...
            savedPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            pedCustomizationMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            spawnPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            addonPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            mainPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            animalsPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            malePedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            femalePedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            otherPedsMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
            ...
            selectedSavedPedMenu.HeaderTexture = new KeyValuePair<string, string>("header", "header");
